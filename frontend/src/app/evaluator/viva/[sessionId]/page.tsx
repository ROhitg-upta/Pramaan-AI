...
export default function EvaluatorVivaWorkbench() {
  ...
  return (
    <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 space-y-6">
      ...
      <div className="mt-8 rounded-xl border border-white/5 bg-zinc-950 p-4 flex flex-col sm:flex-row items-center justify-between text-xs font-mono text-zinc-500 gap-3">
        ...
        >
          <span>Stanford Cyber-Forensics Lab</span>
          <span>↗</span>
        </a>
      </div>
    </div>
